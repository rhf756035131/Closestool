...
import com.example.rahul.closestool.R;
...
//		title.setText("һ������");
		title.setText(this.getResources().getString(R.string.onekeysetting));
...
//				mCheckBox.setText("Show password");
	...
	Button.OnClickListener mButtonStartListener = new Button.OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			IoTManager.StartSmartConnection(SSID, Password, (byte)mAuthMode);
